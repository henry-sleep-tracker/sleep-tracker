...
function UsersContent() {
  ...
  const columns = useMemo(
    () => [
      ...
      { field: 'isSubscribed', headerName: 'Suscripción', type: 'singleSelect', 
        valueOptions: ['true', 'false'], editable: true},
      { field: 'birthday', headerName: 'Nacimiento', type: 'date', editable: true },
      { field: 'isAdmin', headerName: 'Rol', width: 85, type: 'singleSelect', 
        valueOptions: ['true', 'false'], editable: true },
  ...
  return (
    <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
      ...
      <Box sx={{ height: 455, width: '100%' }} >
        ...
        <Typography variant="h5" component="h5" sx={{ textAlign: 'left', mt: 0, mb: 2 }} >
          Usuarios
        </Typography>
