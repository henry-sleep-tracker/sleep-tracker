          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
                ...
                <MenuItem key='reporteS' onClick={handleCloseUserMenu}>
                  <Button   alt='Reporte' href='/pdf' download='{pdf}'  >Reporte semanal</Button>
                </MenuItem>

                <MenuItem key='registro' onClick={handleCloseUserMenu}>
                  <Button   alt='Reporte' href='/actividad'   >Registrar actividad</Button>
                </MenuItem>
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0, marginRight: '20px' }}>
                <Avatar alt="Remy Sharp" src="https://cdn-icons-png.flaticon.com/512/10/10915.png" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
